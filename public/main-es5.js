...
var SignInFormComponent = /** @class */ (function () {
    function SignInFormComponent(userService) {
        this.userService = userService;
        this.user = new _user__WEBPACK_IMPORTED_MODULE_2__["User"]('', '');
    }
    Object.defineProperty(SignInFormComponent.prototype, "diagnostic", {
        get: function () {
    ...
    SignInFormComponent.prototype.onSubmit = function () {
        ...
        this.userService.userVaildate(newUser).subscribe(function (data) {
            console.log(data);
        });
        // this.user.email = '123';
...
var UserService = /** @class */ (function () {
    ...
    // }
    UserService.prototype.userVaildate = function (user) {
